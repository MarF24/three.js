...
class KeyController {
    ...
    tick() {
        ...
        // Uncomment and fix the following lines if needed:
        // if (this.keyListener.isPressed(keyCode.KEY_A)) this.state.rotation.y = 1;
        // if (this.keyListener.isPressed(keyCode.KEY_D)) this.state.rotation.y = -1;
        // if (this.keyListener.isPressed(keyCode.KEY_A)) this.state.angle.y = 1;
        // if (this.keyListener.isPressed(keyCode.KEY_D)) this.state.angle.y = -1;
